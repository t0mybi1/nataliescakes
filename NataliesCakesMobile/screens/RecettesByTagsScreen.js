...
class RecettesByTagsScreen extends React.Component {
    constructor(props) {
        super(props);
    ...
    static navigationOptions = ({ navigation, navigationOptions }) => {
        return {
            title: "Tags : "+navigation.state.params.tag,
    ...
    /*getRecetteByTag(tagToMatch) {
        return recetteTrim = this.state.recettes.filter((recette) => {
            isTag = false;
            recette.tags.forEach(tag => {
                if(tag == tagToMatch) {
                    isTag = true;
    ...
    render() {
        ...
        let recettesFiltered = this.state.recettes.filter((recette) => recette.tags.includes(this.props.navigation.state.params.tag));
        let recettesFav = recettesFiltered.map((recette) =>
        (
            <Content>
                <List>
                    <ListItem thumbnail>
...
export default RecettesByTagsScreen;